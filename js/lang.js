...
(function () {
  ...
  var LANG = {
    ...
    en: {
      ...
      // ---- Inline Settings + Help sections (Wave 9.5) ----
      settings_title:                  "Settings",
      settings_subtitle:               "sweep mode · density profile · appearance · tools",
      settings_sweep:                  "Sweep Engine",
      settings_default:                "(default)",
      settings_sweep_auto_desc:        "Use firmware-side sweep when supported, fall back to browser-side.",
      settings_sweep_browser_desc:     "Browser computes the angle, sends an SRV: every ~85 ms. Works on any firmware.",
      settings_sweep_firmware_desc:    "Browser sends one SWEEP: command, micro:bit drives the servo locally. Silky — needs firmware ≥ v0.1.55.",
      settings_density:                "Density Profile",
      settings_density_sub:            "how much to show on screen",
      settings_density_beginner_desc:  "Just keypad + speed + STOP.",
      settings_density_standard_desc:  "Full cockpit: dashboard, personalities, path, games.",
      settings_density_hacker_desc:    "Standard + BLE sniffer + fuzz panel + synesthesia + fencing.",
      settings_density_demo_desc:      "Beginner + auto-wander pre-armed for showcases.",
      help_title:                      "Help",
      help_subtitle:                   "cheatsheet · troubleshoot · docs",
      help_cheatsheet:                 "⌨️ Keyboard cheatsheet",
      help_kb_wasd:                    "Drive forward / left / back / right",
      help_kb_space:                   "Stop motors",
      help_kb_esc:                     "Emergency STOP (works from anywhere)",
      help_kb_tab:                     "Switch sub-tab (Drive → Servos → …)",
      help_troubleshoot:               "🔧 Quick troubleshooting",
      help_ts_no_connect:              "Won't connect?",
      help_ts_no_connect_desc:         "Use Chrome or Edge (Web Bluetooth required). Make sure the robot is on and not paired with another tab.",
      help_ts_jitter:                  "Servo jittery?",
      help_ts_jitter_desc:             "Open Settings → Sweep Engine → set to Firmware (needs firmware v0.1.55+).",
      help_ts_neopixel:                "NeoPixels don't light?",
      help_ts_neopixel_desc:           "WS2812B + Bluetooth is a hardware-level conflict on micro:bit. The on-screen pearls show your intent; hardware output isn't supported.",
      help_ts_drift:                   "Path map drifts?",
      help_ts_drift_desc:              "Normal — wheel odometry alone has no correction. Flash the bare-metal firmware for compass-corrected SLAM.",
      help_docs:                       "📚 Full documentation",
      help_link_guide:                 "User Guide",
      help_link_robot:                 "Meet your robot",
      help_link_pinout:                "Pinout",
      help_link_github:                "GitHub",
      // ---- Wave 6-8 features (path / minigames / sub-tabs / wander) ----
      mq_wander_obstacle:      "obstacle ≤",
      mq_chal_fig8:            "∞ Figure-8",
      mq_drift_label:          "Drift Champion",
      mq_minigames_label:      "MINI-GAMES",
      mq_echo_btn:             "🎯 Echo Hunt",
      mq_maze_btn:             "🧱 Maze mode",
      mq_soccer_btn:           "⚽ Soccer",
      mq_soccer_red:           "RED",
      mq_soccer_blue:          "BLUE",
      mq_soccer_reset:         "↺ Reset match",
      mq_odo_autopilot:        "draw & go",
      mq_odo_timelapse:        "timelapse",
      mq_odo_ar:               "AR",
      mq_odo_recap:            "recap",
      mq_servo_180:            "180° position",
      mq_servo_360:            "360° speed",
      // SLAM the Room
      mq_slam_label:           "SLAM the Room",
      mq_slam_cells:           "cells:",
      mq_slam_area:            "area:",
      mq_slam_start:           "▶ 60 s run",
      mq_slam_best:            "best:",
      // Math the Distance
      mq_math_title:           "Math the Distance",
      mq_math_sub:             "— predict how far the robot will roll",
      mq_math_best:            "best:",
      mq_math_check:           "Check",
      mq_math_run:             "🚦 Run it",
      mq_math_new:             "🎲 New",
      // PWM Lab
      mq_pwm_lab_title:        "PWM Lab",
      mq_pwm_lab_sub:          "— hit the target servo angle",
      mq_pwm_lab_best:         "best:",
      mq_pwm_lab_target:       "target",
      mq_pwm_lab_submit:       "Lock answer",
      mq_pwm_lab_new:          "New round",
      mq_pwm_lab_hint:         "Tip: the closer your guess to the target, the higher your score. Connected? S1 actually moves to your guess.",
      // Morse Decoder
      mq_morse_title:          "Morse Decoder",
      mq_morse_sub:            "— listen and type what you hear",
      mq_morse_best:           "best:",
      mq_morse_new:            "🎲 New message",
      mq_morse_play:           "▶ Play again",
      mq_morse_check:          "Check",
      mq_morse_hint:           "A=•— · E=• · S=••• · O=——— · T=— · I=•• · N=—•   ( • = short, — = long )",
      // Simon Says
      mq_simon_title:          "Simon Says",
      mq_simon_sub:             "— remember and repeat the color sequence",
      mq_simon_round:          "round:",
      mq_simon_best:           "best:",
      mq_simon_start:          "▶ Start",
      // Buzz the Tune
      mq_tune_title:           "Buzz the Tune",
      mq_tune_sub:             "— tap the keys, robot plays the song",
      mq_tune_demo:            "🎼 Twinkle demo",
      // Line Follower Race
      mq_race_title:           "Line Follower Race",
      mq_race_sub:             "— time the lap on a printed track",
      mq_race_best:            "best:",
      mq_race_start:           "▶ Start",
      mq_race_lap:             "🏁 Lap",
      mq_race_reset:           "↺",
    ...
    fr: {
      ...
      settings_subtitle:               "balayage · densité · apparence · outils",
      settings_sweep:                  "Moteur de balayage",
      settings_default:                "(par défaut)",
      settings_sweep_auto_desc:        "Utilise le balayage firmware si supporté, sinon navigateur.",
      settings_sweep_browser_desc:     "Le navigateur calcule l'angle et envoie un SRV: toutes les ~85 ms. Marche avec tout firmware.",
      settings_sweep_firmware_desc:    "Le navigateur envoie une commande SWEEP:, micro:bit pilote le servo localement. Soyeux — firmware ≥ v0.1.55.",
      settings_density:                "Densité d'affichage",
      settings_density_sub:            "ce qu'on montre à l'écran",
      settings_density_beginner_desc:  "Juste clavier + vitesse + STOP.",
      settings_density_standard_desc:  "Cabine complète : tableau de bord, personnalités, trajectoire, jeux.",
      settings_density_hacker_desc:    "Standard + sniffer BLE + panneau fuzz + synesthésie + escrime.",
      settings_density_demo_desc:      "Débutant + errance auto pré-armée pour démos.",
      help_title:                      "Aide",
      help_subtitle:                   "raccourcis · dépannage · docs",
      help_cheatsheet:                 "⌨️ Raccourcis clavier",
      help_kb_wasd:                    "Conduire avant / gauche / arrière / droite",
      help_kb_space:                   "Arrêter les moteurs",
      help_kb_esc:                     "STOP d'urgence (depuis n'importe où)",
      help_kb_tab:                     "Changer de sous-onglet (Drive → Servos → …)",
      help_troubleshoot:               "🔧 Dépannage rapide",
      help_ts_no_connect:              "Ne se connecte pas ?",
      help_ts_no_connect_desc:         "Utilise Chrome ou Edge (Web Bluetooth requis). Vérifie que le robot est allumé et non appairé avec un autre onglet.",
      help_ts_jitter:                  "Servo qui saute ?",
      help_ts_jitter_desc:             "Ouvre Réglages → Moteur de balayage → mets sur Firmware (firmware v0.1.55+).",
      help_ts_neopixel:                "NeoPixels ne s'allument pas ?",
      help_ts_neopixel_desc:           "WS2812B + Bluetooth = conflit matériel sur micro:bit. Les perles à l'écran montrent ton intention ; la sortie matériel n'est pas supportée.",
      help_ts_drift:                   "La carte de trajectoire dérive ?",
      help_ts_drift_desc:              "Normal — l'odométrie roues seules n'a pas de correction. Flashe le firmware bare-metal pour un SLAM corrigé par boussole.",
      help_docs:                       "📚 Documentation complète",
      help_link_guide:                 "Guide utilisateur",
      help_link_robot:                 "Mon robot",
      help_link_pinout:                "Brochage",
      help_link_github:                "GitHub",
      mq_wander_obstacle:      "obstacle ≤",
      mq_chal_fig8:            "∞ Figure-8",
      mq_drift_label:          "Champion de Dérive",
      mq_minigames_label:      "MINI-JEUX",
      mq_echo_btn:             "🎯 Chasse à l'Écho",
      mq_maze_btn:             "🧱 Mode Labyrinthe",
      mq_soccer_btn:           "⚽ Foot",
      mq_soccer_red:           "ROUGE",
      mq_soccer_blue:          "BLEU",
      mq_soccer_reset:         "↺ Reset match",
      mq_odo_autopilot:        "dessine & roule",
      mq_odo_timelapse:        "accéléré",
      mq_odo_ar:               "RA",
      mq_odo_recap:            "bilan",
      mq_servo_180:            "position 180°",
      mq_servo_360:            "vitesse 360°",
      mq_slam_label:           "SLAM la Pièce",
      mq_slam_cells:           "cellules:",
      mq_slam_area:            "surface:",
      mq_slam_start:           "▶ run 60 s",
      mq_slam_best:            "record:",
      mq_math_title:           "Maths de la Distance",
      mq_math_sub:             "— prédis combien de cm le robot va rouler",
      mq_math_best:            "record:",
      mq_math_check:           "Vérifier",
      mq_math_run:             "🚦 Lancer",
      mq_math_new:             "🎲 Nouveau",
      mq_pwm_lab_title:        "Labo PWM",
      mq_pwm_lab_sub:          "— vise l'angle exact du servo",
      mq_pwm_lab_best:         "record:",
      mq_pwm_lab_target:       "cible",
      mq_pwm_lab_submit:       "Verrouiller",
      mq_pwm_lab_new:          "Nouveau",
      mq_pwm_lab_hint:         "Astuce : plus ta proposition est proche de la cible, plus le score est élevé. Connecté ? S1 bouge vraiment.",
      mq_morse_title:          "Décodeur Morse",
      mq_morse_sub:            "— écoute et tape ce que tu entends",
      mq_morse_best:           "record:",
      mq_morse_new:            "🎲 Nouveau message",
      mq_morse_play:           "▶ Rejouer",
      mq_morse_check:          "Vérifier",
      mq_morse_hint:           "A=•— · E=• · S=••• · O=——— · T=— · I=•• · N=—•   ( • = court, — = long )",
      mq_simon_title:          "Simon Says",
      mq_simon_sub:             "— mémorise et répète la séquence de couleurs",
      mq_simon_round:          "manche:",
      mq_simon_best:           "record:",
      mq_simon_start:          "▶ Commencer",
      mq_tune_title:           "Buzz la Mélodie",
      mq_tune_sub:             "— tape les touches, le robot joue",
      mq_tune_demo:            "🎼 Démo Twinkle",
      mq_race_title:           "Course Suiveur de Ligne",
      mq_race_sub:             "— chronomètre le tour sur la piste imprimée",
      mq_race_best:            "record:",
      mq_race_start:           "▶ Démarrer",
      mq_race_lap:             "🏁 Tour",
      mq_race_reset:           "↺",
    ...
    ar: {
      ...
      settings_subtitle:               "\u0627\u0644\u0645\u0633\u062d \u00b7 \u0627\u0644\u0643\u062b\u0627\u0641\u0629 \u00b7 \u0627\u0644\u0645\u0638\u0647\u0631 \u00b7 \u0627\u0644\u0623\u062f\u0648\u0627\u062a",
      settings_sweep:                  "\u0645\u062d\u0631\u0643 \u0627\u0644\u0645\u0633\u062d",
      settings_default:                "(\u0627\u0641\u062a\u0631\u0627\u0636\u064a)",
      settings_sweep_auto_desc:        "\u0627\u0633\u062a\u062e\u062f\u0645 \u0645\u0633\u062d firmware \u0625\u0630\u0627 \u0643\u0627\u0646 \u0645\u062f\u0639\u0648\u0645\u0627\u064b\u060c \u0648\u0625\u0644\u0627 \u062a\u0631\u0627\u062c\u0639 \u0644\u0644\u0645\u062a\u0635\u0641\u062d.",
      settings_sweep_browser_desc:     "\u0627\u0644\u0645\u062a\u0635\u0641\u062d \u064a\u062d\u0633\u0628 \u0627\u0644\u0632\u0627\u0648\u064a\u0629 \u0648\u064a\u0631\u0633\u0644 SRV: \u0643\u0644 85 ms. \u064a\u0639\u0645\u0644 \u0645\u0639 \u0623\u064a firmware.",
      settings_sweep_firmware_desc:    "\u0627\u0644\u0645\u062a\u0635\u0641\u062d \u064a\u0631\u0633\u0644 \u0623\u0645\u0631 SWEEP: \u0648\u0627\u062d\u062f\u060c micro:bit \u064a\u062f\u064a\u0631 \u0627\u0644\u0633\u064a\u0631\u0641\u0648 \u0645\u062d\u0644\u064a\u0627\u064b. \u0646\u0627\u0639\u0645 \u2014 firmware \u2265 v0.1.55.",
      settings_density:                "\u0643\u062b\u0627\u0641\u0629 \u0627\u0644\u0639\u0631\u0636",
      settings_density_sub:            "\u0643\u0645 \u0646\u0639\u0631\u0636 \u0639\u0644\u0649 \u0627\u0644\u0634\u0627\u0634\u0629",
      settings_density_beginner_desc:  "\u0641\u0642\u0637 \u0644\u0648\u062d\u0629 \u0627\u0644\u0645\u0641\u0627\u062a\u064a\u062d + \u0627\u0644\u0633\u0631\u0639\u0629 + STOP.",
      settings_density_standard_desc:  "\u063a\u0631\u0641\u0629 \u0642\u064a\u0627\u062f\u0629 \u0643\u0627\u0645\u0644\u0629: \u0644\u0648\u062d\u0629\u060c \u0634\u062e\u0635\u064a\u0627\u062a\u060c \u0645\u0633\u0627\u0631\u060c \u0623\u0644\u0639\u0627\u0628.",
      settings_density_hacker_desc:    "Standard + sniffer + \u0644\u0648\u062d\u0629 fuzz + synesth\u00e9sie + \u0645\u0628\u0627\u0631\u0632\u0629.",
      settings_density_demo_desc:      "Beginner + \u0627\u0644\u062a\u062c\u0648\u0627\u0644 \u0627\u0644\u062a\u0644\u0642\u0627\u0626\u064a \u0645\u0633\u0628\u0642 \u0627\u0644\u062a\u0633\u0644\u064a\u062d \u0644\u0644\u0639\u0631\u0648\u0636.",
      help_title:                      "\u0627\u0644\u0645\u0633\u0627\u0639\u062f\u0629",
      help_subtitle:                   "\u0627\u062e\u062a\u0635\u0627\u0631\u0627\u062a \u00b7 \u062d\u0644 \u0627\u0644\u0645\u0634\u0627\u0643\u0644 \u00b7 \u0627\u0644\u0645\u0633\u062a\u0646\u062f\u0627\u062a",
      help_cheatsheet:                 "\u2328\ufe0f \u0627\u062e\u062a\u0635\u0627\u0631\u0627\u062a \u0644\u0648\u062d\u0629 \u0627\u0644\u0645\u0641\u0627\u062a\u064a\u062d",
      help_kb_wasd:                    "\u0642\u064a\u0627\u062f\u0629 \u0623\u0645\u0627\u0645 / \u064a\u0633\u0627\u0631 / \u062e\u0644\u0641 / \u064a\u0645\u064a\u0646",
      help_kb_space:                   "\u0625\u064a\u0642\u0627\u0641 \u0627\u0644\u0645\u062d\u0631\u0643\u0627\u062a",
      help_kb_esc:                     "STOP \u0637\u0648\u0627\u0631\u0626 (\u0645\u0646 \u0623\u064a \u0645\u0643\u0627\u0646)",
      help_kb_tab:                     "\u062a\u0628\u062f\u064a\u0644 \u0627\u0644\u062a\u0628\u0648\u064a\u0628 \u0627\u0644\u0641\u0631\u0639\u064a (Drive \u2192 Servos \u2192 \u2026)",
      help_troubleshoot:               "\ud83d\udd27 \u062d\u0644 \u0633\u0631\u064a\u0639 \u0644\u0644\u0645\u0634\u0627\u0643\u0644",
      help_ts_no_connect:              "\u0644\u0627 \u064a\u062a\u0635\u0644\u061f",
      help_ts_no_connect_desc:         "\u0627\u0633\u062a\u062e\u062f\u0645 Chrome \u0623\u0648 Edge (Web Bluetooth \u0645\u0637\u0644\u0648\u0628). \u062a\u0623\u0643\u062f \u0623\u0646 \u0627\u0644\u0631\u0648\u0628\u0648\u062a \u0645\u0634\u063a\u0651\u0644 \u0648\u063a\u064a\u0631 \u0645\u0642\u062a\u0631\u0646 \u0628\u062a\u0628\u0648\u064a\u0628 \u0622\u062e\u0631.",
      help_ts_jitter:                  "\u0627\u0644\u0633\u064a\u0631\u0641\u0648 \u064a\u0647\u062a\u0632\u061f",
      help_ts_jitter_desc:             "\u0627\u0641\u062a\u062d \u0627\u0644\u0625\u0639\u062f\u0627\u062f\u0627\u062a \u2192 \u0645\u062d\u0631\u0643 \u0627\u0644\u0645\u0633\u062d \u2192 \u0627\u0636\u0628\u0637\u0647 \u0639\u0644\u0649 Firmware (\u064a\u062d\u062a\u0627\u062c firmware v0.1.55+).",
      help_ts_neopixel:                "NeoPixels \u0644\u0627 \u062a\u0636\u064a\u0621\u061f",
      help_ts_neopixel_desc:           "WS2812B + Bluetooth = \u062a\u0639\u0627\u0631\u0636 \u0639\u0644\u0649 \u0645\u0633\u062a\u0648\u0649 \u0627\u0644\u0645\u0639\u062f\u0627\u062a \u0641\u064a micro:bit.",
      help_ts_drift:                   "\u062e\u0631\u064a\u0637\u0629 \u0627\u0644\u0645\u0633\u0627\u0631 \u062a\u0646\u062d\u0631\u0641\u061f",
      help_ts_drift_desc:              "\u0637\u0628\u064a\u0639\u064a \u2014 \u0642\u064a\u0627\u0633 \u0627\u0644\u0645\u0633\u0627\u0641\u0629 \u0645\u0646 \u0627\u0644\u0639\u062c\u0644\u0627\u062a \u0648\u062d\u062f\u0647\u0627 \u0628\u062f\u0648\u0646 \u062a\u0635\u062d\u064a\u062d. \u0646\u0642\u0634 \u0627\u0644\u0640 firmware bare-metal \u0644\u0640 SLAM \u0645\u0635\u062d\u062d \u0628\u0627\u0644\u0628\u0648\u0635\u0644\u0629.",
      help_docs:                       "\ud83d\udcda \u0627\u0644\u0648\u062b\u0627\u0626\u0642 \u0627\u0644\u0643\u0627\u0645\u0644\u0629",
      help_link_guide:                 "\u062f\u0644\u064a\u0644 \u0627\u0644\u0645\u0633\u062a\u062e\u062f\u0645",
      help_link_robot:                 "\u0631\u0648\u0628\u0648\u062a\u064a",
      help_link_pinout:                "Pinout",
      help_link_github:                "GitHub",
      mq_wander_obstacle:      "\u0627\u0644\u0639\u0642\u0628\u0629 \u2264",
      mq_chal_fig8:            "\u221e \u0634\u0643\u0644-8",
      mq_drift_label:          "\u0628\u0637\u0644 \u0627\u0644\u0627\u0646\u062d\u0631\u0627\u0641",
      mq_minigames_label:      "\u0623\u0644\u0639\u0627\u0628 \u0635\u063a\u064a\u0631\u0629",
      mq_echo_btn:             "\ud83c\udfaf \u0635\u064a\u062f \u0627\u0644\u0635\u062f\u0649",
      mq_maze_btn:             "\ud83e\uddf1 \u0648\u0636\u0639 \u0627\u0644\u0645\u062a\u0627\u0647\u0629",
      mq_soccer_btn:           "\u26bd \u0643\u0631\u0629 \u0642\u062f\u0645",
      mq_soccer_red:           "\u0623\u062d\u0645\u0631",
      mq_soccer_blue:          "\u0623\u0632\u0631\u0642",
      mq_soccer_reset:         "\u21ba \u0625\u0639\u0627\u062f\u0629 \u0627\u0644\u0645\u0628\u0627\u0631\u0627\u0629",
      mq_odo_autopilot:        "\u0627\u0631\u0633\u0645 \u0648\u0627\u0646\u0637\u0644\u0642",
      mq_odo_timelapse:        "\u0645\u062a\u0633\u0627\u0631\u0639",
      mq_odo_ar:               "AR",
      mq_odo_recap:            "\u0645\u0644\u062e\u0635",
      mq_servo_180:            "\u0645\u0648\u0636\u0639 180\u00b0",
      mq_servo_360:            "\u0633\u0631\u0639\u0629 360\u00b0",
      mq_slam_label:           "SLAM \u0644\u0644\u063a\u0631\u0641\u0629",
      mq_slam_cells:           "\u0627\u0644\u062e\u0644\u0627\u064a\u0627:",
      mq_slam_area:            "\u0627\u0644\u0645\u0633\u0627\u062d\u0629:",
      mq_slam_start:           "\u25b6 60 \u062b",
      mq_slam_best:            "\u0623\u0641\u0636\u0644:",
      mq_math_title:           "\u062d\u0633\u0627\u0628 \u0627\u0644\u0645\u0633\u0627\u0641\u0629",
      mq_math_sub:             "\u2014 \u062a\u0648\u0642\u0639 \u0643\u0645 \u0633\u064a\u0646\u0637\u0644\u0642 \u0627\u0644\u0631\u0648\u0628\u0648\u062a",
      mq_math_best:            "\u0623\u0641\u0636\u0644:",
      mq_math_check:           "\u062a\u062d\u0642\u0642",
      mq_math_run:             "\ud83d\udea6 \u0634\u063a\u0651\u0644",
      mq_math_new:             "\ud83c\udfb2 \u062c\u062f\u064a\u062f",
      mq_pwm_lab_title:        "\u0645\u062e\u062a\u0628\u0631 PWM",
      mq_pwm_lab_sub:          "\u2014 \u0623\u0635\u0628 \u0627\u0644\u0632\u0627\u0648\u064a\u0629 \u0627\u0644\u0645\u0633\u062a\u0647\u062f\u0641\u0629 \u0644\u0644\u0633\u064a\u0631\u0641\u0648",
      mq_pwm_lab_best:         "\u0623\u0641\u0636\u0644:",
      mq_pwm_lab_target:       "\u0627\u0644\u0647\u062f\u0641",
      mq_pwm_lab_submit:       "\u062a\u0623\u0643\u064a\u062f \u0627\u0644\u0625\u062c\u0627\u0628\u0629",
      mq_pwm_lab_new:          "\u062c\u0648\u0644\u0629 \u062c\u062f\u064a\u062f\u0629",
      mq_pwm_lab_hint:         "\u0646\u0635\u064a\u062d\u0629: \u0643\u0644\u0645\u0627 \u0627\u0642\u062a\u0631\u0628 \u062a\u062e\u0645\u064a\u0646\u0643 \u0645\u0646 \u0627\u0644\u0647\u062f\u0641\u060c \u0627\u0631\u062a\u0641\u0639\u062a \u0627\u0644\u0646\u062a\u064a\u062c\u0629. \u0645\u062a\u0635\u0644\u061f \u0627\u0644\u0633\u064a\u0631\u0641\u0648 S1 \u064a\u062a\u062d\u0631\u0643 \u0641\u0639\u0644\u0627\u064b.",
      mq_morse_title:          "\u0645\u0641\u0643\u0643 \u0627\u0644\u0634\u064a\u0641\u0631\u0629",
      mq_morse_sub:            "\u2014 \u0627\u0633\u062a\u0645\u0639 \u0648\u0627\u0643\u062a\u0628 \u0645\u0627 \u0633\u0645\u0639\u062a",
      mq_morse_best:           "\u0623\u0641\u0636\u0644:",
      mq_morse_new:            "\ud83c\udfb2 \u0631\u0633\u0627\u0644\u0629 \u062c\u062f\u064a\u062f\u0629",
      mq_morse_play:           "\u25b6 \u0623\u0639\u062f \u0627\u0644\u062a\u0634\u063a\u064a\u0644",
      mq_morse_check:          "\u062a\u062d\u0642\u0642",
      mq_morse_hint:           "A=\u2022\u2014 \u00b7 E=\u2022 \u00b7 S=\u2022\u2022\u2022 \u00b7 O=\u2014\u2014\u2014 \u00b7 T=\u2014 \u00b7 I=\u2022\u2022 \u00b7 N=\u2014\u2022   ( \u2022 = \u0642\u0635\u064a\u0631, \u2014 = \u0637\u0648\u064a\u0644 )",
      mq_simon_title:          "Simon Says",
      mq_simon_sub:             "\u2014 \u062a\u0630\u0643\u0631 \u0648\u0643\u0631\u0631 \u062a\u0633\u0644\u0633\u0644 \u0627\u0644\u0623\u0644\u0648\u0627\u0646",
      mq_simon_round:          "\u0627\u0644\u062c\u0648\u0644\u0629:",
      mq_simon_best:           "\u0623\u0641\u0636\u0644:",
      mq_simon_start:          "\u25b6 \u0627\u0628\u062f\u0623",
      mq_tune_title:           "\u0627\u0639\u0632\u0641 \u0627\u0644\u0644\u062d\u0646",
      mq_tune_sub:             "\u2014 \u0627\u0636\u063a\u0637 \u0627\u0644\u0645\u0641\u0627\u062a\u064a\u062d\u060c \u0627\u0644\u0631\u0648\u0628\u0648\u062a \u064a\u0639\u0632\u0641",
      mq_tune_demo:            "\ud83c\udfbc \u0639\u0631\u0636 Twinkle",
      mq_race_title:           "\u0633\u0628\u0627\u0642 \u0645\u062a\u0627\u0628\u0639 \u0627\u0644\u062e\u0637",
      mq_race_sub:             "\u2014 \u0633\u062c\u0651\u0644 \u0648\u0642\u062a \u0627\u0644\u0644\u0641\u0629 \u0639\u0644\u0649 \u0627\u0644\u0645\u0633\u0627\u0631 \u0627\u0644\u0645\u0637\u0628\u0648\u0639",
      mq_race_best:            "\u0623\u0641\u0636\u0644:",
      mq_race_start:           "\u25b6 \u0627\u0628\u062f\u0623",
      mq_race_lap:             "\ud83c\udfc1 \u0644\u0641\u0629",
      mq_race_reset:           "\u21ba",
